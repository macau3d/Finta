...
const COLOR_MAP = {
  amber: {
    ...
    miss: "bg-slate-500/10 dark:bg-slate-700/40 border-slate-400/20 dark:border-slate-600/30 text-slate-400 dark:text-slate-500",
    text: "text-amber-400",
  },
  sky: {
          ...
          return (
            <div
              ...
              className={cn(
                ...
                s.value === null
                  ? "opacity-30 border-slate-400/20 dark:border-slate-600/20 bg-slate-400/10 dark:bg-slate-700/10"
                  : s.hit
                  ? c.hit
                  : c.miss
              )}
